<?php
// source: C:\xampp\htdocs\scrips\josefvarak\app/config/common.neon
// source: C:\xampp\htdocs\scrips\josefvarak\app/config/local.neon
// source: array
...
class Container_2b3b66d688 extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\scrips\josefvarak\app/../temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\scrips\josefvarak\app/../temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\IStorage
	{
		return new Nette\Caching\Storages\FileStorage(
			'C:\xampp\htdocs\scrips\josefvarak\app/../temp/cache',
			$this->getService('cache.journal')
		);
	}


	public function createServiceContainer(): Container_2b3b66d688
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_2b3b66d688 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\scrips\josefvarak\app/../temp/cache/latte');
